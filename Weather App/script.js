...
const pressure = document.getElementById('pressure'); // Added pressure element
const location_not_found = document.querySelector('.location-not-found');
const weather_body = document.querySelector('.weather-body');

async function checkWeather(city){
    const api_key = "166f9e1d0affb1eae9ac675c57342fcf";
    ...
    pressure.innerHTML = `${weather_data.main.pressure} hPa`; // Update pressure value
